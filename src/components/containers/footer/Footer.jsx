...
const Footer = () => {
  return (
    <footer className='footer'>
      <div className='footer__contenedor  container'>
        <p className='footer__parrafo'>
          © {new Date().getFullYear()} whitecode.dev, Inc. All rights reserved.
        </p>
        ...
        <div className='footer__redes'>
          ...
          <a href='https://github.com/MartinAlexanderFloresTorres' target='_blank' rel='noreferrer'>
            <span>GitHub</span>
            <svg fill='currentColor' viewBox='0 0 24 24'>
              <path
                fillRule='evenodd'
